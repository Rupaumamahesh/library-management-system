...
public class MemberController implements Initializable {
    ...
    @FXML private TableColumn<Member, Integer> borrowedCountColumn;
    ...
    private void loadMembers() {
        ...
        Task<List<Member>> task = ApiClient.getInstance().getMembers();
    ...
    private void handleDelete() {
        ...
        // ✅ FIX: save task to variable, attach listeners, start SAME instance
        Task<Void> task = ApiClient.getInstance().deleteMember(selected.getId());
